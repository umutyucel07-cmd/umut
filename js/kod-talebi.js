...
(function () {
  ...
  function KodTalebiFormu() {
    ...
    return e(Card, { padding: 'sm', topRule: true },
      ...
      e('p', { style: { fontSize: 'var(--text-caption)', color: 'var(--text-muted)', marginTop: 6, lineHeight: 'var(--leading-relaxed)' } }, 'Ad soyadınızı ve büromuza kayıtlı telefon numaranızı yazınız. Bilgileriniz kayıtlarımızla eşleşirse erişim kodunuz kayıtlı WhatsApp numaranıza gönderilir; kod ekranda gösterilmez. Her talepte yeni kod üretilir ve önceki kodunuz geçersiz olur.'),
      e('form', { onSubmit: gonder, style: { display: 'flex', flexDirection: 'column', gap: 'var(--space-3)', marginTop: 'var(--space-3)' } },
        ...
        // KANAL SECIMI KALDIRILDI (13.08.2026).
        // E-posta kanali sunucuda kapali: MailChannels'in Workers icin ucretsiz
        // servisi sona erdi ve yerine saglayici baglanmadi. Dugme ekranda
        // dururken sunucunun "bu kanal kullanilamiyor" demesi, muvekkile once
        // bir secenek gosterip sonra geri almaktir. Secenek kaldirildi.
        // Kanal geri acilirsa once /api/kod-talebi icindeki 'kanal-yok' dali
        // kaldirilmali, sonra bu dugmeler geri konmali - bu sirayla.
      ...
      // KVKK m.10 aydinlatma yukumlulugu: bu form kisisel veri (ad + telefon)
      // topluyor. Randevu formunda aydinlatma vardi, burada YOKTU.
      e('p', { style: { fontSize: 'var(--text-caption)', color: 'var(--text-faint)', marginTop: 'var(--space-2)', lineHeight: 'var(--leading-relaxed)' } },
        'Bu formda verdiğiniz ad ve telefon bilgisi yalnızca kimliğinizin doğrulanması ve erişim kodunun tarafınıza iletilmesi amacıyla işlenir; başka bir amaçla kullanılmaz ve üçüncü kişilerle paylaşılmaz. Ayrıntılı bilgi sitemizdeki KVKK Aydınlatma Metni’nde yer almaktadır.'),
