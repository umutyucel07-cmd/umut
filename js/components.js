...
function Button({
  ...
  return /*#__PURE__*/React.createElement(Tag, _extends({
    ...
    size: size === 'lg' ? 18 : 16,
    style: {
      animation: 'lexa-spin 900ms linear infinite'
    }
  }) : icon ? /*#__PURE__*/React.createElement(Icon, {
    name: icon,
    size: size === 'lg' ? 20 : 16
  }) : null, children, iconEnd ? /*#__PURE__*/React.createElement(Icon, {
    name: iconEnd,
    size: size === 'lg' ? 20 : 16
  }) : null);
}
...
function Card({
  ...
  }, rest), topRule ? /*#__PURE__*/React.createElement("span", {
    style: {
      position: 'absolute',
      insetInline: 0,
      top: 0,
...
function Tag({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    ...
    name: icon,
    size: 14
  }) : null, children, onRemove ? /*#__PURE__*/React.createElement(Icon, {
    name: "x",
    size: 14,
    style: {
      opacity: .6,
...
function Avatar({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    style: {
      ...
      fontFamily: 'var(--font-sans)',
      fontWeight: 'var(--weight-semibold)',
      fontSize: px <= 28 ? 11 : px <= 40 ? 14 : px <= 56 ? 18 : 28,
      letterSpacing: '.02em',
      ...tones[tone],
      ...style
    }
...
function Textarea({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      fontSize: 'var(--text-caption)',
      color: error ? 'var(--status-danger-fg)' : 'var(--text-faint)'
    }
  }, /*#__PURE__*/React.createElement("span", null, error || hint || ''), counterMax ? /*#__PURE__*/React.createElement("span", {
    className: "mono"
  }, len, "/", counterMax) : null));
}
function Select({
...
function Switch({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      boxShadow: '0 1px 2px rgba(11,22,38,.25)',
...
function Tabs({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      display: 'flex',
      gap: underline ? 'var(--space-6)' : 'var(--space-1)',
      alignItems: 'stretch',
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        border: 0,
        borderBottom: underline ? '2px solid ' + (active ? 'var(--brass-500)' : 'transparent') : 0,
        borderRadius: underline ? 0 : 'var(--radius-xs)',
        padding: underline ? '0 0 var(--space-3)' : '6px var(--space-4)',
...
function Toast({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: t.icon,
    size: 18,
    color: tone === 'success' ? 'var(--brass-400)' : t.color,
    style: {
      marginTop: 1
    }
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }, action.label) : null, onClose ? /*#__PURE__*/React.createElement(Icon, {
    name: "x",
    size: 16,
    color: "var(--text-on-dark-muted)",
    style: {
...
function AppointmentSlot({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      gap: 5,
      fontSize: 'var(--text-micro)',
      color: selected ? 'var(--text-on-dark-muted)' : disabled ? 'var(--text-faint)' : c.color
    }
  }, /*#__PURE__*/React.createElement(Icon, {
    name: c.icon,
    size: 12
  }), c.label, " \xB7 ", duration));
}
const caseStatusMap = {
  active: {
    tone: 'info',
...
function CaseStatusCard({
  ...
  return /*#__PURE__*/React.createElement(Card, {
  ...
  }, fileNo, court ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    style: {
      opacity: .5
    }
  }, " \xB7 "), court) : null), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 4,
      borderRadius: 999,
      background: 'var(--paper-3)',
  ...
  }, nextDate ? /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 6
    ...
    size: 14,
    color: "var(--text-faint)"
  }), nextDate) : null, unread > 0 ? /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 6,
...
function MessageBubble({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "sparkles",
    size: 12
  }), "\xD6n De\u011Ferlendirme") : null, children, attachment ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 'var(--space-2)',
      ...
      borderRadius: 'var(--radius-sm)',
      background: mine ? 'rgba(255,255,255,.10)' : 'var(--surface-sunken)',
      fontSize: 'var(--text-caption)'
    }
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "paperclip",
    size: 14
  }), attachment) : null, isAi && aiNote ? /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 'var(--space-3)',
      paddingTop: 'var(--space-3)',
      borderTop: '1px solid var(--brass-200)',
      fontSize: 'var(--text-micro)',
      color: 'var(--brass-800)'
    }
  }, aiNote) : null), time ? /*#__PURE__*/React.createElement("span", {
    className: "mono",
    style: {
      color: 'var(--text-faint)',
      fontSize: 'var(--text-micro)'
